...
エンジニアの生産性を高めるため、AIコーディングツールを積極的に導入しています。GitHub Copilot、Cursor、Claude Codeなどは希望者が利用でき、全社的にはGeminiを導入しています。

これらのツールは、コード補完やリファクタリング、テストコードの生成、タスク管理などの場面で活用されており、開発効率の向上に大きく貢献しています。

新しいツールについても、社内のセキュリティガイドラインに従って評価・導入を進めています。
